...
func UpdateTime(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func Location(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func UpdateTimeEQ(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdateTime), v))
	})
}
...
func UpdateTimeNEQ(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func UpdateTimeIn(vs ...time.Time) predicate.Storage {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeNotIn(vs ...time.Time) predicate.Storage {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeGT(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func UpdateTimeGTE(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func UpdateTimeLT(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func UpdateTimeLTE(v time.Time) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationEQ(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLocation), v))
	})
}
...
func LocationNEQ(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationIn(vs ...string) predicate.Storage {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LocationNotIn(vs ...string) predicate.Storage {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LocationGT(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationGTE(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationLT(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationLTE(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationContains(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationHasPrefix(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationHasSuffix(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationEqualFold(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
...
func LocationContainsFold(v string) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldLocation), v))
	})
}

// HasStorageSerial applies the HasEdge predicate on the "storage_serial" edge.
func HasStorageSerial() predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StorageSerialTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, StorageSerialTable, StorageSerialColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasStorageSerialWith applies the HasEdge predicate on the "storage_serial" edge with a given conditions (other predicates).
func HasStorageSerialWith(preds ...predicate.Serial) predicate.Storage {
	return predicate.Storage(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StorageSerialInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, StorageSerialTable, StorageSerialColumn),
		)
